...
* `--downloadlegal`
    * This downloads the latest legal documents, renders them into html from markdown and puts them in the includes folder of the respective site.
    * You only need to run this when one of the documents updates.
